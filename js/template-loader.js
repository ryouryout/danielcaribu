...
export async function loadAllTemplates() {
  ...
  modalsContainer.innerHTML = popupModalHtml + finetuneModalHtml + calibCenterModalHtml + welcomeModalHtml + autoCalibCenterModalHtml + rangeModalHtml + edgeProgressModalHtml + edgeModalHtml + quickTestModalHtml + calibrationHistoryModalHtml;
